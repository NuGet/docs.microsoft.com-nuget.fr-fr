...
# Démarrages rapides
## [Installer et utiliser un package (CLI dotnet)](quickstart/install-and-use-a-package-using-the-dotnet-cli.md)
## [Installer et utiliser un package (Visual Studio)](quickstart/install-and-use-a-package-in-visual-studio.md)
## [Créer et publier un package NET Standard (CLI dotnet)](quickstart/create-and-publish-a-package-using-the-dotnet-cli.md)
...
## [Vue d’ensemble et workflow](consume-packages/overview-and-workflow.md)
...
### [Packages signés](consume-packages/installing-signed-packages.md)
...
# Créer des packages
## [Vue d’ensemble et workflow](create-packages/overview-and-workflow.md)
...
## [Transformations de fichiers config et fichiers sources](create-packages/source-and-config-file-transformations.md)
...
# Outils
## [Informations de référence sur l’interface CLI nuget.exe](tools/nuget-exe-cli-reference.md)
...
## [Contrôle de version des packages](reference/package-versioning.md)
## [Fichier nuget.config](reference/nuget-config-file.md)
## [Cibles de MSBuild](reference/msbuild-targets.md)
## [Versions cibles de .NET Framework](reference/target-frameworks.md)
...
## [SDK du client NuGet](reference/nuget-client-sdk.md)
...
### [Pousser et supprimer](api/package-publish-resource.md)
### [Pousser des packages de symboles](api/symbol-package-publish-resource.md)
### [URL pour signaler un abus](api/report-abuse-resource.md)
### [Signatures de dépôt](api/repository-signatures-resource.md)
### [Rechercher](api/search-query-service-resource.md)
### [Index de service](api/service-index.md)
## [Guide pratique pour interroger tous les packages à l’aide de l’API](guides/api/query-for-all-published-packages.md)
