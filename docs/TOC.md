...
## [Installer et utiliser un package (Visual Studio pour Mac)](quickstart/install-and-use-a-package-in-visual-studio-mac.md)
...
### [Migrer packages.config vers PackageReference](consume-packages/migrate-packages-config-to-package-reference.md)
...
## [Meilleures pratiques de création de packages](create-packages/Package-authoring-best-practices.md)
...
### [Créer un package pour Xamarin avec Visual Studio 2017 ou 2019](guides/create-packages-for-xamarin.md)
...
## [Meilleures pratiques pour une chaîne d’approvisionnement de logiciels sécurisée](concepts/Security-Best-Practices.md)
## [Résolution des problèmes de packages installés](concepts/troubleshooting-installed-packages.md)
# Référence
...
## [Questions fréquentes (FAQ)](resources/nuget-faq.yml)
