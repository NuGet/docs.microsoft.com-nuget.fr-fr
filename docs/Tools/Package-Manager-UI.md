...
1. Notez que la **incluent preprelease** et **source du Package** contrôles n’ont aucun effet lors de la désinstallation des packages.
...
Dans cet exemple, le projet ClassLibrary1 est à l’aide de EntityFramework 6.2.0, tandis que ConsoleApp1 est à l’aide de EntityFramework 6.2.0. Pour consolider les versions de package, procédez comme suit :
