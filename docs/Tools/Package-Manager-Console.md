...
## <a name="setting-up-a-nuget-powershell-profile"></a>Configuration d’un profil de NuGet PowerShell
...
## <a name="using-the-nugetexe-cli-in-the-console"></a>À l’aide de l’interface CLI de nuget.exe dans la console
