...
---
# <a name="quickstart-create-and-publish-a-nuget-package-using-visual-studio-net-standard"></a>Démarrage rapide : Créer et publier un package NuGet avec Visual Studio (.NET Standard)
