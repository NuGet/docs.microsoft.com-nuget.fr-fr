1. <span data-ttu-id="07e03-101">Accédez au dossier contenant le fichier `.nupkg`.</span><span class="sxs-lookup"><span data-stu-id="07e03-101">Change to the folder containing the `.nupkg` file.</span></span>
