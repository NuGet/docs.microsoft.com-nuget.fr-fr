...
Cette section fournit une procédure pas à pas détaillée sur la façon de restaurer les packages dans [Team Services Build](/vsts/build-release/index) pour Git et la gestion de versions Team Services.
